 ...
 *   <li>{@link org.eclipse.emf.henshin.model.impl.EdgeImpl#getPresenceCondition <em>Presence Condition</em>}</li>
...
public class EdgeImpl extends EObjectImpl implements Edge {
	...
	public void setPresenceCondition(String newPresenceCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HenshinPackage.EDGE__PRESENCE_CONDITION, oldPresenceCondition, presenceCondition));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HenshinPackage.EDGE__ACTION:
				return getAction();
			case HenshinPackage.EDGE__PRESENCE_CONDITION:
