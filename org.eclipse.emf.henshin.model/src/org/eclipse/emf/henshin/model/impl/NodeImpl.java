 ...
 *   <li>{@link org.eclipse.emf.henshin.model.impl.NodeImpl#getPresenceCondition <em>Presence Condition</em>}</li>
...
public class NodeImpl extends NamedElementImpl implements Node {
	...
	public void setPresenceCondition(String newPresenceCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HenshinPackage.NODE__PRESENCE_CONDITION, oldPresenceCondition, presenceCondition));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HenshinPackage.NODE__ACTION:
				return getAction();
			case HenshinPackage.NODE__PRESENCE_CONDITION:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == GraphElement.class) {
			switch (derivedFeatureID) {
				...
				case HenshinPackage.NODE__PRESENCE_CONDITION: return HenshinPackage.GRAPH_ELEMENT__PRESENCE_CONDITION;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == GraphElement.class) {
			switch (baseFeatureID) {
				...
				case HenshinPackage.GRAPH_ELEMENT__PRESENCE_CONDITION: return HenshinPackage.NODE__PRESENCE_CONDITION;
				default: return -1;
			}
		}
