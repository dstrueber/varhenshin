 ...
 *   <li>{@link org.eclipse.emf.henshin.model.impl.AttributeImpl#getPresenceCondition <em>Presence Condition</em>}</li>
...
public class AttributeImpl extends EObjectImpl implements Attribute {
	...
	public void setPresenceCondition(String newPresenceCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HenshinPackage.ATTRIBUTE__PRESENCE_CONDITION, oldPresenceCondition, presenceCondition));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HenshinPackage.ATTRIBUTE__ACTION:
				return getAction();
			case HenshinPackage.ATTRIBUTE__PRESENCE_CONDITION:
